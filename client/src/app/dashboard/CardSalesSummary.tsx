...
const CardSalesSummary = () => {
    ...
    const highestValuaData = salesData.reduce((acc, curr) => {
        return acc.totalValue > curr.totalValue ? acc : curr;
    }, salesData[0] || {})

    const highestValueDate = highestValuaData.date ? new Date(highestValuaData.date).toLocaleDateString("en-GB", {
        day: "numeric",
        month: "numeric",
        year: "2-digit"
        ...
        {isLoading ? (
            ...
            <div>
                ...
                <div className="flex justify-between items-center mb-6 px-7 mt-5">
                    ...
                    <select className="shadow-sm border border-gray-300 bg-white p-2 rounded" value={timeframe}
