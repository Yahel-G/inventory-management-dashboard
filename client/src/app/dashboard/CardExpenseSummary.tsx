...
const CardExpenseSummary = () => {
  ...
  const { data: dashboardMeterics, isLoading } = useGetDashboardMetricsQuery();
 
  const expenseSummary = dashboardMeterics?.expenseSummary[0];

  const expenseByCategorySummary = dashboardMeterics?.expenseByCategorySummary || [];
        ...
        {isLoading ? (
            ...
            <>
                ...
                <div className="xl:flex justify-between pr-7">
                    {/* CHART */}
                    <div className="relative basis-3/5"> {/* Sets the text in the middle of the pie chart */}
                    ...
                    {expenseSummary && (
                        <div className="mt-3 flex justify-between items-center px-7 mb-4">
                            ...
                            <span className="flex items-center mt-2">
                                <TrendingUp className="mr-2 text-green-500" /> {/* Currently just example value*/}
                                30%
                            </span>
                        </div>
                    )}
