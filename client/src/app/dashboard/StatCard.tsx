...
const StatCard = ({
  ...
  return (
    <div className="md:row-span-1 xl:row-span-2 col-span-1 bg-white shadow-md rounded-2xl flex flex-col h-full">
      {/* HEADER */}
      ...
      {/* BODY */}
      <div className="flex-grow overflow-auto px-5 py4">
